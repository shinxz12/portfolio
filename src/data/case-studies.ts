...
export const caseStudies: CaseStudy[] = [
  {
    ...
    contributions: [
      ...
      "Designed and built end-to-end order orchestration with Temporal for multi-step order processing across distributed services.",
      "Designed and built commerce integrations around the order lifecycle: VNPay payments, FAST invoice workflows, MySign electronic signing, and Trade Credit reward workflows.",
